...
exports.setupSpecificationSystemMigration = void 0;
...
const specificationTemplate_model_1 = require("../modules/specificationTemplate/specificationTemplate.model");
const setupSpecificationSystemMigration = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield product_model_1.ProductModel.updateMany({}, {
            $unset: {
                bookInfo: 1,
                previewPdf: 1,
        ...
        yield createDefaultSpecificationTemplates();
...
exports.setupSpecificationSystemMigration = setupSpecificationSystemMigration;
const createDefaultSpecificationTemplates = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const template of defaultTemplates) {
        ...
        if (category) {
            ...
            if (!existingTemplate) {
                yield specificationTemplate_model_1.SpecificationTemplateModel.create({
                    categoryId: category._id,
...
if (require.main === module) {
    (0, exports.setupSpecificationSystemMigration)()
        .then(() => {
        console.log("Migration completed successfully!");
        process.exit(0);
    })
