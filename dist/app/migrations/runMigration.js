...
const MONGODB_URI = process.env.DATABASE_URL || "mongodb://localhost:27017/your-database";
...
const runMigration = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const updateResult = yield product_model_1.ProductModel.updateMany({}, {
            $unset: {
                bookInfo: 1,
                previewPdf: 1,
...
const createDefaultSpecificationTemplates = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const template of defaultTemplates) {
        try {
            ...
            console.error(`   ❌ Error creating template for ${template.categoryName}:`, error);
        }
    }
});
